...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationClient = (FusedLocationProviderClient) LocationServices.getFusedLocationProviderClient(this);
                ...
                supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        if (location != null){
                            ...
                            Toast.makeText(MapActivity.this, "Please Turn on App Location Permission", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
